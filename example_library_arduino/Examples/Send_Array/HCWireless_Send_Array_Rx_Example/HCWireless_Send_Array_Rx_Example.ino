/* FILE:    HCWireless_Send_Array_Rx_Example.ino
   DATE:    19/06/19
   VERSION: 1.0
...
an array. This sketch should be used in conjunction with the HCWireless_Send_Array_Tx_Example 
...
// Create an array to hold the received data
byte data[10];
...
void loop() 
{
  ...
  if(size)
  {
    // ...if so then transfer the data out of the Rx buffer and into the array 
